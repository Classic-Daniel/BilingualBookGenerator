...
class Parser:    
    def sentencesFromFile(self, filePath: str) -> list[str]:
        ...
        if(fileExtension == ".rtf"):
            return RtfParser().sentencesFromFile(filePath)
            
        elif(fileExtension == ".txt"):
            return TxtParser().sentencesFromFile(filePath)
            
        elif(fileExtension == ".doc"):
            return DocParser().sentencesFromFile(filePath)
    ...
    def _processPlainText(self, plainText: str) -> list[str]:
        ...
        filteredSentences = list(map(self._filterSentence, sentences))
        return filteredSentences
        
    """
    Splits the text into arrays of sentences
    """
    def _splitTextToSentences(self, text: str) -> list[str]:
    ...
    """
    def _filterSentence(self, text: str) -> str:
